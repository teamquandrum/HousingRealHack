...
public class RegList extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] gg = {" "};
        adapter = new ArrayAdapter<String>(RegList.this, R.layout.list_item, R.id.firstLine, gg );
        ...
        param.add(new BasicNameValuePair("controller", "property"));
        param.add(new BasicNameValuePair("action", "getallproperty"));
        ...
        HttpPost hp = new HttpPost("http://housinghack.gear.host/index.php/manager");
        try {
            ...
            public void run(String content) {
                ...
                try {
                    ...
                    for(int i=0; i<questions.length();i++)
                    {
                        ...
                        title[i]=q.getString("description");
                        body[i]=q.getString("address");
                        askerid[i]=q.getString("price");
                        qid[i]=q.getString("propid");
                        System.out.println(title[i]);
                    }
                    System.out.println("sup?");
                    MyAdapter adapter = new MyAdapter(RegList.this, generateData());
                    ...
                    listView.setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view,
          				...
          				startActivity(i);
          				*/
                            Intent i = new Intent(RegList.this, PointsActivity.class);
                            i.putExtra("description", title[position]);
                            i.putExtra("address", body[position]);
                            i.putExtra("propid", qid[position]);
                            i.putExtra("price", askerid[position]);
                            startActivity(i);
                        }
                    });
    ...
    private class InflateItems extends AsyncTask<String, String, String>{
        ...
        protected void onPostExecute(String result) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(RegList.this, R.layout.list_item, R.id.firstLine, app);
            lv.setAdapter(adapter);
